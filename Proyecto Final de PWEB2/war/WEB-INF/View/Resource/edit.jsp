						...
						<div class="formulario">
							<form action="/resource/edit" method="post">
								<label><b>Dirección (URL): </b></label> <br> <input
									type="text" name="url" id="url" pattern="^/[a-z]+(/[a-z]+)?$"
									value="<%=resource.getUrl()%>"></input> <br> <label><b>Estado:</b></label>
								<br> <select name="status">
									...
									value="<%=resource.getId()%>"> <input name="boton"
									class="boton" type="submit" value="Editar Recurso">
							</form>
						</div>
						<div class=link>
